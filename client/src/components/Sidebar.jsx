    ...
    <div className={`bg-[#8185B2]/10 h-full p-5 rounded-r-xl overflow-y-scroll text-white ${selectedUser ? "max-md:hidden" : ''}`}>
        <div className='pb-5'>
            <div className='flex items-center justify-between'>
                ...
                <div className='relative py-2'>
                    <img src={assets.menu_icon} alt="menu" className='max-h-5 cursor-pointer' onClick={()=>setShowMenu(v=>!v)}/>
                    {showMenu && (
                        <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-mg bg-[#282142] border border-gray-600 text-gray-100'>
            ...
            <div className='bg-[#282142] rounded-full flex items-center gap-4 px-2 py-3 mx-1 my-4'>
        ...
        <div className='flex flex-col'>
            {filteredUsers.map((user, index) => (
                <div onClick={()=> {setSelectedUser(user); setUnseenMessages(
